# -*- coding: utf-8 -*-
"""
Created on Sun Jun  7 15:20:17 2020
...
def admin():
    ...
    y=model.predict(t)
    return render_template("pro.html", y ="The Price of Natural Gas for the date "+date_time_str+" would be "+str(y[0])+" Dollars per Million BTU")
